        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastServiceDate = table.Column<DateTime>(type: "date", nullable: true),
                    NextServiceDate = table.Column<DateTime>(type: "date", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EngineHours = table.Column<decimal>(type: "decimal(10,1)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlantedDate = table.Column<DateTime>(type: "date", nullable: false),
                    ExpectedHarvestDate = table.Column<DateTime>(type: "date", nullable: true),
                    GrowthStagePercent = table.Column<int>(type: "int", nullable: false),
                    NextTask = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Location = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    SoilType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SunlightExposure = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    IsIndoor = table.Column<bool>(type: "bit", nullable: false),
                    AvgTemperatureCelsius = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    WateringFrequencyDays = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Location = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    InstallationDate = table.Column<DateTime>(type: "date", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceHistory_Machinery_MachineryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerPhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ListingType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ListingStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EngineHours = table.Column<decimal>(type: "decimal(10,1)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MarketplaceListings_Machinery_MachineryId",
                        column: x => x.MachineryId,
                        principalTable: "Machinery",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResourceUsages_Plants_PlantId",
                        column: x => x.PlantId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceHistory_MachineryId",
                table: "MaintenanceHistory",
                column: "MachineryId");

            migrationBuilder.CreateIndex(
                name: "IX_MarketplaceListings_MachineryId",
                table: "MarketplaceListings",
                column: "MachineryId");

            migrationBuilder.CreateIndex(
                name: "IX_ResourceUsages_PlantId",
